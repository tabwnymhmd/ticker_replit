...
virtualenv-app-data
â”œâ”€â”€ py - <version> <cache information about python interpreters>
â”‚Â Â  â””â”€â”€ *.json/lock
â”œâ”€â”€ wheel <cache wheels used for seeding>
â”‚ Â  â”œâ”€â”€ house
â”‚   â”‚   â””â”€â”€ *.whl <wheels downloaded go here>
â”‚   â””â”€â”€ <python major.minor> -> 3.9
â”‚       â”œâ”€â”€ img-<version>
â”‚       â”‚   â””â”€â”€ image
â”‚       â”‚           â””â”€â”€ <install class> -> CopyPipInstall / SymlinkPipInstall
â”‚       â”‚               â””â”€â”€ <wheel name> -> pip-20.1.1-py2.py3-none-any
â”‚       â””â”€â”€ embed
â”‚           â””â”€â”€ 1
â”‚               â””â”€â”€ *.json -> for every distribution contains data about newer embed versions and releases
â””â”€â”€â”€ unzip <in zip app we cannot refer to some internal files, so first extract them>
     â””â”€â”€ <virtualenv version>
         â”œâ”€â”€ py_info.py
         â”œâ”€â”€ debug.py
         â””â”€â”€ _virtualenv.py
"""
