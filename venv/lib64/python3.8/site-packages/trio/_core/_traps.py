...
async def temporarily_detach_coroutine_object(abort_func):
    ...
    object. In fact, you have to â€“ the function doesn't return until the
    ...
    this :class:`Task` object to retrieve the coroutine object â€“ see
    :data:`Task.coro`.
...
async def reattach_detached_coroutine_object(task, yield_value):
    ...
    """
    # This is a kind of crude check â€“ in particular, it can fail if the
